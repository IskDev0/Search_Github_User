<template>
  <form @submit.prevent="getUser"
    ...
    <div class="flex items-center bg-transparent gap-0 sm:gap-4">
      ...
      <input v-model="search"
             class="bg-transparent w-72 pl-4 py-2 placeholder-white focus:outline-none dark:placeholder-black"
             type="text"
