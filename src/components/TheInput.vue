<template>
  <form @submit.prevent="getUser"
        class="flex flex-col justify-between rounded-md gap-4 bg-[#1F2A48] p-4 w-fulls mx-auto dark:bg-white dark:text-black lg:flex-row">
    <div class="flex items-center bg-transparent w-full gap-0 sm:gap-4">
      ...
      <input v-model="search"
             class="bg-transparent flex-1 pl-4 py-2 placeholder-white focus:outline-none dark:placeholder-black"
             type="text"
