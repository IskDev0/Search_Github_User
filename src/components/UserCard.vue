<template>
  <div class="bg-[#1F2A48] w-1/2 mx-auto p-12 mt-10 rounded-lg">
    <div class="flex justify-between items-start">
      ...
      <div class="w-3/4">
        <div class="flex flex-col">
          ...
          <div class="flex justify-between bg-[#141C2F] py-4 px-8 rounded-lg my-8">
            <div class="flex flex-col">
              <span>Repos</span>
